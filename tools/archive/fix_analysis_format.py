#!/usr/bin/env python3
"""
Re-analyze 06-25-00068-CR to get proper formatted output
"""
import sys
import sqlite3
...
def fix_case_analysis():
    """Re-analyze case 06-25-00068-CR with proper formatting"""
    ...
    logger.info(f"Re-analyzing {case_number} for proper format...")
    ...
    try:
        ...
        # Analyze with Claude - this will use the full pdrbot-prompt
        logger.info("Analyzing with full prompt...")
        ...
        logger.info("Successfully saved properly formatted analysis")
        return True
